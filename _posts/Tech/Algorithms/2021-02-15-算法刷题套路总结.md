...
![image-20210216110346629](https://cdn.jsdelivr.net/gh/mafulong/mdPic@v1/v1/125.png)



### 根据时间复杂度找算法

![image-20210216110406039](https://cdn.jsdelivr.net/gh/mafulong/mdPic@v1/v1/145.png)
...
![image-20210217124654829](https://cdn.jsdelivr.net/gh/mafulong/mdPic@v1/v1/96.png)
...
bfs分两种，一种是单源的，一种是多源的，多源一般要反向边来搞。
...
![image-20210217124242846](https://cdn.jsdelivr.net/gh/mafulong/mdPic@v1/v1/140.png)
