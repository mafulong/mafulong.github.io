...
Kafka没有提供同步刷盘的方式。[同步刷盘](https://zhida.zhihu.com/search?content_id=156458315&content_type=Article&match_order=2&q=同步刷盘&zhida_source=entity)在RocketMQ中有实现，实现原理是将异步刷盘的流程进行阻塞，等待响应，类似ajax的callback或者是java的future。
