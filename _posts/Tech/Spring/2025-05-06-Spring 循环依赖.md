...
## [Spring 可以解决哪些情况的循环依赖？](https://javabetter.cn/sidebar/sanfene/spring.html#spring-可以解决哪些情况的循环依赖)
...
## [Spring 怎么解决循环依赖呢？](https://javabetter.cn/sidebar/sanfene/spring.html#_16-spring-怎么解决循环依赖呢)
...
### [三级缓存解决循环依赖的过程是什么样的？](https://javabetter.cn/sidebar/sanfene/spring.html#三级缓存解决循环依赖的过程是什么样的)
...
### [为什么要三级缓存？⼆级不⾏吗？](https://javabetter.cn/sidebar/sanfene/spring.html#_17-为什么要三级缓存-二级不行吗)
...
#### [如果缺少第二级缓存会有什么问题？](https://javabetter.cn/sidebar/sanfene/spring.html#如果缺少第二级缓存会有什么问题)
