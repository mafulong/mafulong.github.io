...
defer func(p P) {}(x) 这个时候x已经赋值给p了
  ...
  这里的 `someVar` 会在 `defer` 声明时求值，而不是在实际执行时。
  
  
  
  如果是指针，就是复制它指针的地址。比如下面代码，go func 时传入的是v这个循环变量的地址，因此输出是three, three, three.  [参考](https://www.topgoer.com/%E8%B5%84%E6%96%99%E4%B8%8B%E8%BD%BD/Golang%E6%96%B0%E6%89%8B%E5%8F%AF%E8%83%BD%E4%BC%9A%E8%B8%A9%E7%9A%8450%E4%B8%AA%E5%9D%91.html#47for-%E8%AF%AD%E5%8F%A5%E4%B8%AD%E7%9A%84%E8%BF%AD%E4%BB%A3%E5%8F%98%E9%87%8F%E4%B8%8E%E9%97%AD%E5%8C%85%E5%87%BD%E6%95%B0)
...
func main() {
    ...
    var d4 Describer = Address{"Paris"} // ❌ 编译错误：指针接收者 `*T` 不能用 `T{}` 赋值
    d4.Describe()
}
