...
[详情可以参考 helloworld](https://mafulong.github.io/springmvc/2018/08/03/springMVC-helloworld.html)

## @Controller

你需要在配置中加入组件扫描的配置代码来开启框架对注解控制器的自动检测。请使用下面 XML 代码所示的 spring-context schema：
