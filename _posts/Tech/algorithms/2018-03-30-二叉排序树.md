...
public class BST {
    ...
    public Node findNode(Node root,int a){
        if(root==null)
            return null;
        if(root.data==a){
            return root;
            ...
            return findNode(root.left,a);
        }
    }
    public Node insertNode(Node root,int a){
        if(root==null){
            return new Node(a);
        }else{
            if(root.data<a){
    ...
    public void visitLVR(Node root){
        if(root==null) return;
        visitLVR(root.left);
    ...
    @Test
    public void t1(){
        int[] a=new int[]{1,23,2,3,1,2,34,1,2,34};
